...
Pod::Spec.new do |s|
  s.name             = 'KTFoundation'
  s.version          = '0.1.0'
  s.summary          = 'A short description of KTFoundation.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/KOTU/KTFoundation.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'KTFoundation' => ['KTFoundation/Assets/*.png']
  # }
